...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Upload for gallery" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'gallery');`,
        ...
        `CREATE POLICY "Public Delete for gallery" ON storage.objects FOR DELETE USING (bucket_id = 'gallery');`
    ];
